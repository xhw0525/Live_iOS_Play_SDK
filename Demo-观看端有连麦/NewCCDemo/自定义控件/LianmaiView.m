...
-(void)timefunc {
    ...
    if(self.isVideo) {
        ...
        self.msgLabel.text = [NSString stringWithFormat:@"语音连麦中 %02d:%02d",minutes,seconds];
    }
}
